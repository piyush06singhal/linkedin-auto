        ...
        <div className="max-w-5xl mx-auto p-8">
          ...
          <div className="bg-blue-50 rounded-2xl border border-blue-200 p-6 mb-8">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-semibold text-blue-900 mb-1">Lead Discovery Available</h3>
                <p className="text-sm text-blue-700">0/10 discoveries used this week • 10 remaining</p>
              </div>
